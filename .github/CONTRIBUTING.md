# Contribute to Paid Memberships Pro - Update Manager
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-update-manager/issues/new/choose)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-update-manager.git` to set the upstream repo
...
* Ensure you stick to the [WordPress Coding Standards](https://developer.wordpress.org/coding-standards/wordpress-coding-standards/) (even though much of the PMPro code does not currently)
